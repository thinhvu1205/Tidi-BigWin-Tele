...
public class SabongGameView : GameView
{
    ...
    public void HandleFinishGame(JObject data)
    {
        ...
        //==========================================
        async UniTask onFinishGame(JObject data)
        {
    ...
    private async UniTask _ClearTable(JObject data = null)
    {
        if (data != null)
        {
            ...
            await UniTask.Delay((int)(timeUp + timeMove + 1) * 1000);
            ...
            await UniTask.Delay((int)(timeUp + 2 * timeMove) * 1000);
    ...
    private async UniTask _ShowHideChipBetButtons(bool isShow)
    {
    ...
    private async UniTask _GetCards()
    {
